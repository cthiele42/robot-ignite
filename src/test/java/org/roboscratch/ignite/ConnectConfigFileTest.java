 ...
 */
public class ConnectConfigFileTest {
    ...
    public static void setup() throws Exception {
        ...
        URL configUrl = ConnectConfigFileTest.class.getResource("/local-ignite-config.xml");
    ...
    @Test
    public void testIgniteConnectionWithConfigFile() throws Exception {
        keywords.connectToIgnite(configPath);
